						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							...
							<div class="" role="tabpanel" data-example-id="togglable-tabs">
								<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
									...
									<li role="presentation" class="active"><a href="#tab_content2"
										...
										aria-expanded="true">Missions Worked on</a></li>
							...
							<div role="tabpanel" class="tab-pane fade active in"
								...
								<table class="data table table-striped no-margin">
									...
									<tbody>
										<s:iterator value="thirdParty.association" var="association"
											status="rowstatus">
											
											<tr>
												<td><s:property
														value="#association.mission.missionName" /></td>
												<td class="hidden-phone"><s:property
														value="#association.mission.timesheetLines.size" /></td>
