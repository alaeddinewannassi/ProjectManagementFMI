                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      ...
                      <ul class="list-unstyled user_data">
                        <li><i class="fa fa-map-marker user-profile-icon"></i> <s:property value="thirdParty.adresse"/>
                        </li>

                        <li>
                          <i class="fa fa-briefcase user-profile-icon"></i> <s:property value="thirdParty.jobTitle"/>
                        </li>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          ...
                          <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Missions Worked on</a>
                          </li>
