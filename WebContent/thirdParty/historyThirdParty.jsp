                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      <div class="profile_img">
                        <div id="crop-avatar">
                          <!-- Current avatar -->
                          <img class="img-responsive avatar-view" src="images/<s:property value="contributor.firstName"/>.jpg" alt="Avatar" title="Change the avatar">
                        </div>
                      </div>
                      <h3> <s:property value="thirdParty.firstName"/> <s:property value="contributor.lastName"/> </h3>

                      <ul class="list-unstyled user_data">
                        <li><i class="fa fa-map-marker user-profile-icon"></i> <s:property value="contributor.adresse"/>
                        </li>

                        <li>
                          <i class="fa fa-briefcase user-profile-icon"></i> <s:property value="contributor.jobTitle"/>
                        </li>
