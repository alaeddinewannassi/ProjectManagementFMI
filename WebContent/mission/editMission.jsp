			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<form id="demo-form2" data-parsley-validate=""
						...
						method="post" action="editMission.action">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<input type="text" name="missionName"
									value="<s:property value="mission.missionName" />"
									required="required" class="form-control col-md-7 col-xs-12">
							</div>
						</div>
						...
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12"
								for="workload"> Workload (Per days) <span
								class="required">*</span>
							</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input id="workload" type="text" name="workload"
									required="required"
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="description" required="required"
									value="<s:property value="mission.description" />"
									class="form-control col-md-7 col-xs-12">
							</div>
						</div>
