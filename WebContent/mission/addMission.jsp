...
<%@ taglib prefix="s" uri="/struts-tags"%>  
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                   <s:form id="demo-form2"  cssClass="form-horizontal form-label-left" method="post" action="saveMission.action">
					...
					<p style="color: red;">
                       ...
                       <s:select cssStyle="padding:10px ; margin-left: 180px; margin-top: -120px;" name="selectedProject" list="projects" listKey="projectName" listValue="projectName" 
                 	...
                 	<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="missionName" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
