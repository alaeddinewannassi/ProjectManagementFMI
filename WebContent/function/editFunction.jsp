					...
					<p style="color: red;">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="text" name="functionName" value="<s:property value="function.functionName" />"  required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="description" required="required" value="<s:property value="function.description" />"  class="form-control col-md-7 col-xs-12"> 
                        </div>
                      </div>
