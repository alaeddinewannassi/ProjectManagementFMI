	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3>
					Functions <small>Listing design</small>
				</h3>
			</div>
								...
								<tbody>
									<s:iterator value="functions" var="function" status="rowstatus">
										<tr>
											...
											<td><a><s:property value="#function.functionName" /></a>
											</td>
											...
											<td class="project_progress">
												<div class="progress progress_sm">
													<div class="progress-bar bg-green" role="progressbar"
														data-transitiongoal="<s:property value="#function.status"/>"></div>
												</div> <s:property value="status" /> <small> Complete</small>
											</td>

											<td>
												<!--  EDIT FUNCTION --> <s:url id="editURL"
													action="modifyFunction.action">
													<s:param name="id" value="%{id}"></s:param>

												</s:url> <s:a href="%{editURL}" cssClass="btn btn-info btn-xs">
													<i class="fa fa-pencil"></i> Edit </s:a> <!--  REMOVE FUNCTION -->
