          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Teams <small>Listing design</small></h3>
              </div>
                      ...
                      <s:iterator value="teams" status="rowstatus">
                        <tr>
                         ...
                         <td>
                            ...
                            <!--  VIEW TEAM -->
                          <s:url id="viewURL" action="detailTeam.action" >
	                     ...
	                     <!--  EDIT TEAM -->
	                         <s:url id="editURL" action="modifyTeam.action" >
	                          <s:param name="id" value="%{id}"></s:param>
	                          </s:url>
                         ...
                         <!--  REMOVE TEAM -->
                          <s:url id="removeURL" action="removeTeam.action" >
                          <s:param name="id" value="%{id}"></s:param>
                          </s:url>
