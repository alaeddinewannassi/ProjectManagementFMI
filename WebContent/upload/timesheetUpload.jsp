			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<s:form theme="simple" id="demo-form2"
						...
						action="timesheetResult.action" enctype="multipart/form-data">
						...
						<div class="form-group" style="margin-left: 200px">
							...
							&nbsp; &nbsp;
							<s:select id="projectSelect"
								cssStyle="padding:10px ; margin-left:100px ; margin-top: -120px;"
								cssClass="selectpicker" list="session.projects" listKey="projectName"
						...
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12"
								for="timesheet" style="margin-left: 40px"> Import
								timesheet : </label>
