                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <ul class="stats-overview">
                        <li>
                          ...
                          <span class="value text-success"> <s:property value="budget"/> </span>
                        </li>
                        <li>
                        ...
                        <li class="hidden-phone">
                          ...
                          <span class="value text-success"> <s:property value="period"/> </span>
                        </li>
                      </ul>
                      <br />
                      ...
                      <section class="panel">
                        ...
                        <div class="panel-body">
                          ...
                          <div class="project_detail">
                            ...
                            <p><s:property value="client"/></p>
                            <p class="title">Project Leader</p>
                            <p>Tony Chicken</p> // loggedIn User
                          </div>
