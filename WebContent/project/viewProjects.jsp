					...
					<div class="x_content">
						...
						<form action="" method="post">
							...
							<table class="table table-striped projects">
								...
								<tbody>
									<s:iterator value="session.projects" var="project" status="rowstatus">
										<tr>
											<td><s:property value="#project.id" /></td>
											<td><a><s:property value="#project.projectName" /></a> <br />
												<small>Created <s:property
														value="#project.creationDate" /></small></td>
											...
											<td class="project_progress">
												<div class="progress progress_sm">
													<div class="progress-bar bg-green" role="progressbar"
														data-transitiongoal="<s:property value="#project.status"/>"></div>
												</div> <s:property value="#project.status" /> <small>
													Complete</small>
											</td>

											<td>
												<!--  VIEW PROJECT --> <s:url id="viewURL"
													action="detailProject.action">
													<s:param name="id" value="%{id}"></s:param>
												</s:url> <s:a href="%{viewURL}" cssClass="btn btn-primary btn-xs">
													<i class="fa fa-folder"></i> View </s:a> <!--  EDIT PROJECT --> <s:url
													id="editURL" action="modifyProject.action">
													<s:param name="id" value="%{id}"></s:param>
												</s:url> <s:a href="%{editURL}" cssClass="btn btn-info btn-xs">
													<i class="fa fa-pencil"></i> Edit </s:a> <!--  REMOVE PROJECT -->
